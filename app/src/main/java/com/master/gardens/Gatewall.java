...
public class Gatewall extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authListener = firebaseAuth -> {
            ...
            if (user1 == null) {
                startActivity(new Intent(Gatewall.this, Login.class));
                finish();
            }
        };
        ...
        navigation.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.home:
                        Intent a = new Intent(Gatewall.this, Home.class);
                        startActivity(a);
                        break;
                    case R.id.search:
                        Intent b = new Intent(Gatewall.this, Search.class);
                        startActivity(b);
                        break;
                    case R.id.about:
                        Intent c = new Intent(Gatewall.this, About.class);
                        startActivity(c);
                        break;
                }
                return false;
        ...
        clusterManager.setOnClusterClickListener(cluster -> {
            ...
            googleMap.animateCamera(CameraUpdateFactory.newLatLng(cluster.getPosition()), new GoogleMap.CancelableCallback() {
                ...
                public void onFinish() {
                    ListViewDialog listViewDialog = new ListViewDialog(Gatewall.this, listNames);
